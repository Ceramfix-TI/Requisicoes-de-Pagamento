function servicetask60(attempt, message) {
	//recuperar os aprovadores 1 e 2 da ordem de compra
	var aAprov1 = [];
	var aAprov2 = [];
    ...
    try{    
		...
		while(resultSetWD.next()) {
			...
			if( rsWD.next() ) {
				...
				log.info( 'Valores  '+ resultSetWD.getString( 'preco_est' )+" "+resultSetWD.getString( 'perc_reateio')+" "+rsWD.getString( 'val_aprov_cc_1' )+" "+rsWD.getString( 'val_aprov_cc_2' )+" "+rsWD.getString( 'val_aprov_1' )+" "+rsWD.getString( 'matricula_aprov_2')  );
